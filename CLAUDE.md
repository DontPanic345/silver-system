...
_
I'm putting my commentary between __,
My comments like this are **explicitly read only**, unless you have specific insturctions.
...
e.g a telephone game: each summary gets read by the next agent as
ground truth rather than as an interpretation.
e.g. The Goals in night-shift were interpreted and generated, only a few of them came from me.
_
